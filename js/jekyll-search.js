...
if(idioma.toLowerCase() == "pt-br"){
  ...
  json: '/search.json',
  searchResultTemplate: '<div class="search-result-block-container focusable"><div class="search-result-block-title"><div class="row"><div class="c3"><a href="{url}"><figure><img src="https://img.youtube.com/vi/{video_id}/mqdefault.jpg" alt="{title}"><figcaption>{title}</figcaption></figure></a></div></div></div>',
