...
(function ($) {
      ...
      if ($YouTubeModal == null) {
        ...
        var modalContent = '<div class="modal-dialog" id="YouTubeModalDialog">' +
                              '<div class="modal-content" id="YouTubeModalContent">' +
                                ...
                                '</div>' +
                                '<div class="modal-body" id="YouTubeModalBody" style="padding:0 5px 5px 0;"></div>' +
                              '</div>' +
                            '</div>';
  ...
  function getYouTubePlayer(URL, width, height) {
    return ['<style>.embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class="embed-container"><iframe title="YouTube video player" ',
